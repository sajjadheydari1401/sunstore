      ...
      <main className="py-3">
        <Container>
          <Switch>
            ...
            <ProtectedRoute path="/admin/productlist" component={ProductListScreen} exact />
            <ProtectedRoute path="/admin/productlist/:pageNumber" component={ProductListScreen} exact />
            <ProtectedRoute path="/admin/product/:id/edit" component={ProductEditScreen} />
            <ProtectedRoute path="/admin/orderlist" component={OrderListScreen} />
            <ProtectedRoute path="/search/:keyword" component={HomeScreen} exact />
            <ProtectedRoute path="/page/:pageNumber" component={HomeScreen} exact />
            <ProtectedRoute path="/search/:keyword/page/:pageNumber" component={HomeScreen} exact/>
